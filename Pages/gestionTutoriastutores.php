...
<head>
  ...
  <title>Gestión de Citas/Tutorías - ITS Jerez</title>
  <!-- Bootstrap CSS -->
  ...
  <style>
    ...
    .card { margin-bottom: 30px;margin-top: 30px; margin-left: 5px; margin-right: 5px; background-color: var(--color-gris-claro); padding: 20px;  border-radius: 8px;  flex: 1; text-align: center; }
    .dashboard {margin-bottom: 30px; display: flex; gap: 20px;  transition: transform 0.3s, box-shadow 0.3s; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1)}
    .dashboard:hover { transform: translateY(-5px); box-shadow: 0 12px 20px rgba(0, 0, 0, 0.2);}
 </style>
</head>
<body>
  ...
  <div class="container">
    ...
    <div class="dashboard">
      <div class="card">
          ...
          <p>20 estudiantes</p>
          <a href="#" class="btn btn-primary">Ver Estudiantes</a><!--lista de los estudiantes asignados-->
      </div>
      <div class="card" >
          <h3>Próximas tutorías</h3>
          <p>5 tutorías programadas</p>
          <a href="#" class="btn btn-primary">Ver tutorias</a><!--lista de las tutorias programadas-->
        </div>
      <div class="card">
      ...
      <div class="card-body">
        ...
        <form id="formReservarTutoria" onsubmit="reservarTutoria(event)">
          <div class="form-row">
              ...
              <div class="form-group col-md-4">
                <label for="tutorAsignado">estudiantes Asignados</label>
                <select class="form-control" id="estudianteAsignado" name="id_estudiante" required>
                 <!--que se puedan selecionar varios estudiantes pero que de de alta cada estudiante por separado-->
                </select>
              </div>              
          </div>
    ...
    <div class="card-custom mb-4" id="listaTutorias">
      <div class="card-body">
      ...
      tutorias.forEach(tutoria => {
        const fila = `
          <tr>
            ...
            <td>
              <button class="btn btn-success btn-sm" onclick="confirmarSesion(${tutoria.id_tutoria})">Confirmar</button>
